...
<div class="card text-dark mt-5">
  ...
  <div class="card-body">
  	...
  	<form:form enctype='multipart/form-data' action="${contextRoot}/topGun/vendorPhotos/post" modelAttribute="vendorPhotos" method='POST'>
  		...
  		<c:if test='${vendorPhotos.vendorPhotosId != null}'>
  		 <div class="mb-3 row">
		    ...
		    <div class="col-sm-10">
		    	<form:input path="vendorPhotosId" class="form-control" id="inputVendorPhotosId" />
		    </div>
		  </div>
		 </c:if>
