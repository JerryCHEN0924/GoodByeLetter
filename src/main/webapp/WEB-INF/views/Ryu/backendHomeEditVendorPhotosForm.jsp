...
<div class="card text-dark mt-5">
  ...
  <div class="card-body">
  	...
  	<form:form enctype='multipart/form-data' action="${contextRoot}/topGun/backendHome/vendorPhotos/put/${vendorPhotos.vendorPhotosId}" modelAttribute="vendorPhotos" method='POST'>
