  ...
  <ul class="pagination justify-content-center">
    	...
    	<c:choose>
			...
			<c:when test="${page.number > 0}">
				...
				<li class="page-item">
				<a class="page-link" href="${contextRoot }/topGun/vendorPhotos/page?p=${page.number - 0}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a>
				</li>
		...
		<c:choose>
			...
			<c:when test="${page.number+1 != pageNumber }">
				...
				<li class="page-item">
				<a class="page-link" href="${contextRoot }/topGun/vendorPhotos/page?p=${pageNumber }">${pageNumber }</a>
				</li>
    	...
    	<c:choose>
			...
			<c:when test="${page.number+1 < page.totalPages}">
				...
				<li class="page-item">
					<a class="page-link" href="${contextRoot }/topGun/vendorPhotos/page?p=${page.number + 2}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a>
				</li>
...
<%--       			<a class="btn btn-outline-success" type="button" href="<c:url value='/topGun/vendorPhotos/put/${vendorPhotos.vendorPhotosId}' />">編輯</a> --%>
				...
				<form:form action="${contextRoot}/topGun/vendorPhotos/put/${vendorPhotos.vendorPhotosId}" method="get" >
...
<%-- 				</form:form> --%>
				...
				<form:form action="${contextRoot}/topGun/vendorPhotos/delete/${vendorPhotos.vendorPhotosId}" method="delete" >
