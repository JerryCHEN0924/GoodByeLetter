...
<%-- 		    		<c:when test="${memberDetail.gender == secret}"> --%>
...
<div class="row my-3">
			...
			<div class="offset-sm-5 col-sm-2">
				...
				<form action="${contextRoot}/topGun/memberDetail/page" method="get" >
					<input type="submit" class="btn btn-outline-warning" value="回查詢會員細項" />
				</form>
