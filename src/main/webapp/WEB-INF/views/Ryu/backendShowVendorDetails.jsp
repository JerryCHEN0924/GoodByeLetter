...
<div class="card">
  ...
  <div class="card-body">
	  ...
	  <tbody>
	    ...
	    <tr>
	      <td>${vendorDetails.vendorDetailsId}</td>
	      <td>${vendorDetails.companyName}</td>
	      <td>${vendorDetails.companyType}</td>
	      <td>${vendorDetails.email}</td>
	      <td>${vendorDetails.address}</td>
...
<%-- 			<a class="btn btn-outline-danger" type="button" href="<c:url value='/topGun/vendorDetails/delete/${vendorDetails.vendorDetailsId}' />">刪除</a> --%>
