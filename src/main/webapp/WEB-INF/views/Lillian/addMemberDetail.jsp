...
<<<<<<< HEAD:src/main/webapp/WEB-INF/jsp/Lillian/addMemberDetail.jsp
<c:set var="contextRoot" value="${pageContext.request.contextPath}"/>
=======
>>>>>>> cfe05aa490c9edba01a31550bb2e785b03eb97a0:src/main/webapp/WEB-INF/views/Lillian/addMemberDetail.jsp
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
	...
	<!-- regis -->
       <div class="mb-3 row">
                        ...
                        <div class="mb-3 row">
                            ...
                            <div class="col-sm-10">
                                <div class="form-check form-check-inline ">
                                    <input type="radio" class="form-check-input" name="gender" id="maleRadio" name="
                                        value="male"> <label class="form-check-label" for="maleRadio"> 男性 </label>
                                </div>
                                <div class="form-check form-check-inline ">
