							...
							<div class="container" id="form_container">
								...
								<form:form id="register_form" action="${contextRoot}/register/add"
									...
									<div class="mb-6 row">
										...
										<div class="col-sm-10">
											<form:input type="text" path="account" placeholder="account(請輸入6~12碼)"
												class="form-control" maxlength="12" minlength="6" id="account" name="account" />
									...
									<div class="mb-6 row">
										...
										<div class="col-sm-10">
											<form:input type="password" path="password" placeholder="password(請輸入6~12碼)"
												class="form-control" maxlength="12" minlength="6" id="password" name="password" />
										</div>
									</div>
