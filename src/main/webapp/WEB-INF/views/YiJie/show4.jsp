				...
				<table>
					<c:forEach items="${listPicture}" var="picture">
						<tr>
							<div class="happy">
								<div class="bdcard">
									<img src="${contextRoot}/customer/picture/otherimage?pictureId=${picture.id}" 
										width="150px" height="150px" alt="other image">
								</div>
	...
	<script>
		$(document).ready(function() {
    		$("img.lawyer-image").click(function() {
        		...
        		$.get("/customer/picture/otherdetail", {pictureId: pictureId}, function(data) {
            		var html = "";
            		for (var key in data) {
