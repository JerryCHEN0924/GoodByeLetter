...
<<<<<<< HEAD
					<li class="nav-item dropdown "><a
						...
						data-bs-toggle="dropdown" aria-expanded="false"> 合作夥伴 </a>
						<ul class="dropdown-menu  "
							aria-labelledby="navbarDropdownMenuLink"
							id="dropdown-menu_company">
							<li><a class="dropdown-item narbar_text_color"
								href="mycompany.html">諮商所</a></li>
					...
					<li class="nav-item dropdown "><a
						class="nav-link dropdown-toggle narbar_text_color" href="#"
						id="navbarDropdownMenuLink" role="button"
						data-bs-toggle="dropdown" aria-expanded="false"> 登入 </a>
						<ul class="dropdown-menu  "
							aria-labelledby="navbarDropdownMenuLink" id="dropdown-menu_login">
							<li><a class="dropdown-item narbar_text_color"
								id="nav_login"> 登入 </a></li>
							<li><a class="dropdown-item narbar_text_color"
								href="myregister.html"> 註冊 </a></li>
							<li><a class="dropdown-item narbar_text_color"
					...
					<a class="nav-link dropdown-toggle narbar_text_color"
						href="#" tabindex="-1" data-bs-toggle="dropdown" role="button" id="navbarDropdownMenuLink"
					...
					<li class="nav-item "><a
						class="nav-link disabled narbar_text_color" href="#" tabindex="-1"
...
>>>>>>> ac17756d18ef3a1e7058f119a9c98ade0bf2e08e
	...
	<div class="container login_form_class" id="login_form">
		<h1>登入</h1>
		<form>
			<input type="text" placeholder="您的帳號"><br> <input
				type="text" placeholder="您的密碼"><br>
			<button type="submit" id="login_submit">
				<h6 id="login_h6">登入</h6>
			</button>
		</form>
		...
		<a href="">忘記密碼</a> <a href="">還沒有帳號，我要申請</a>
	</div>
