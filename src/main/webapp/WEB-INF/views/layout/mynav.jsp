				...
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse show" id="navbarWithDropdown">
						<ul class="navbar-nav">
							...
							<li class="nav-item  dropdown "><a
								class="nav-link dropdown-toggle narbar_text_color" href="#"
								tabindex="-1" data-bs-toggle="dropdown" role="button"
								id="navbarDropdownMenuLink" aria-disabled="false">GoodBye
									Letter</a>
								<ul class="dropdown-menu"
									aria-labelledby="navbarDropdownMenuLink" id="dropdown-menu_GL">
									<li><a class="dropdown-item narbar_text_color"
							...
							<li class="nav-item "><a
								class="nav-link disabled narbar_text_color" href="#"
