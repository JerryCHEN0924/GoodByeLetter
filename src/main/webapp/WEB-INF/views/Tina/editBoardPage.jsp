	...
	<article id="myspace" class="wrapper style2" style="height: 100vh">
		<div class="container">
			...
			<div class="card">
				...
				<h5><form:input path="title" value="${newboard.title}" placeholder="title" class="form-control"/>
				</h5><br>
				...
				<div class="card-body">
					...
					<form:textarea path="boardMessage" value="${newboard.boardMessage}" placeholder="boardMessage" class="form-control"/>
					</div>
					<br>
					<%--編輯按鈕 --%>
						<input type="hidden" name="boardId" value="${newboard.boardId}" />
						<input type="submit" class="btn btn-outline-info" value="送出編輯" />		
				</div>
				</form:form>
